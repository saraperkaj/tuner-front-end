...
//   const classes = useStyle();
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar  position="fixed" sx={{ top: 'auto', bottom: 0, height:80, background: "#7B79C6" }}>
        ...
        >
       <HomeIcon color='disabled' fontSize='large' sx={{color:"white"}}/>
       <Typography variant='subtitle1'>Home</Typography>
        ...
        <IconButton
          ...
          sx={{display:"block", margin:0}}
        >
        <SearchIcon color='disabled' fontSize='large'sx={{color:"white"}}/>
       <Typography variant='subtitle1'>Search</Typography>
        ...
        <IconButton
          ...
          sx={{display:"block", margin:0}}
        >
        <LibraryMusicIcon color='disabled' fontSize='large'sx={{color:"white"}}/>
